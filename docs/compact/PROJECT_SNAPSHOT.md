...
- direct report intake now accepts numeric, bounded/text, and first genetic categorical entries, but broader vendor-specific categorical semantics still need hardening
...
1. Expand vendor-specific categorical mappings and richer text-valued semantics without hiding provenance.

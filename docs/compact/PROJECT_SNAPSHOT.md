...
- canonical measurement storage and promotion are still numeric-only
...
1. Extend measurement storage and promotion beyond numeric-only values so bounded, categorical, and text results can use the catalog too.

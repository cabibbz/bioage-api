...
- direct report intake now accepts numeric, bounded/text, and first genetic categorical entries with initial ApoE/MTHFR notation plus MTHFR copy-count normalization, but broader vendor-specific categorical semantics still need hardening
...
1. Expand vendor-specific categorical value normalization beyond the current ApoE/MTHFR notation and copy-count rules without hiding provenance.

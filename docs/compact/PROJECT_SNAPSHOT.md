...
1. Expand vendor-specific categorical value normalization beyond the current ApoE SNP, MTHFR, and first qualitative plus bounded lab wording rules without hiding provenance.

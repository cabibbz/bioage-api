...
- expanded the browser suite to upload a ZIP archive, verify extracted-child and multi-task rendering, and compare the visible dashboard lists against persisted records instead of only checking counts

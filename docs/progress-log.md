...
- locked promoted review decisions so later review-save attempts are rejected, and added API plus UI regression coverage that proves those blocked updates leave persisted state unchanged

...
- the current vendor-specific categorical normalization rules now canonicalize ApoE genotype notation including rs429358/rs7412 SNP phrasing, MTHFR copy-count and dual-negative wording, and the first non-genetic qualitative lab phrases such as `borderline high` or `not detected`, while preserving the original notation in report-ingestion notes

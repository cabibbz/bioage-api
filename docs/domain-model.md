...
- the current vendor-specific categorical normalization rules now canonicalize ApoE genotype notation including rs429358/rs7412 SNP phrasing plus MTHFR copy-count and dual-negative wording while preserving the original notation in report-ingestion notes

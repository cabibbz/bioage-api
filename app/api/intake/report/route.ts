...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      nextActions: [
        "Expand vendor-specific categorical value normalization beyond the current ApoE SNP, MTHFR, and first qualitative, bounded, detection-limit, assay-qualified, positive-or-negative-for-process, prefix-style process, result-labeled, parenthetical process, and colon-labeled process lab wording rules.",
